...
<div class="col-md-4 ">
   ...
   <div class="moviedetailinforright">
                        <hr>
                        <h4 class="text-center"><b style="color: white">PHIM MỚI NHẤT</b></h4>
                        <hr>
                        <div>
                            <div>
              ...
              <a href="{{URL::to('/chi-tiet-film/'.$pro->film_id)}}" >
                              <h3 class="card__title" style="color: white"><a href="{{URL::to('/chi-tiet-film/'.$pro->film_id)}}" style="color: white">{{$pro->film_ten}}</a></h3>
                <span class="card__category">
                <a href="{{URL::to('/chi-tiet-film/'.$pro->film_id)}}"style="color: white">{{$pro->time}}</a>
              </span>
              </a>
        ...
        <div class="col-6 col-sm-4 col-md-3 col-xl-2">
          ...
          <a href="{{URL::to('/chi-tiet-film/'.$pro->film_id)}}">
            ...
            <div class="card__content">
              <a href="{{URL::to('/chi-tiet-film/'.$pro->film_id)}}" >
                              <h3 class="card__title"><a href="{{URL::to('/chi-tiet-film/'.$pro->film_id)}}">{{$pro->film_ten}}</a></h3>
                <span class="card__category">
                <a href="{{URL::to('/chi-tiet-film/'.$pro->film_id)}}">{{$pro->time}}</a>
              </span>
              </a>
