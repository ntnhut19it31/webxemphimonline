			...
			<div class="row">
				<div class="col-12">
					<div class="header__content">
						...
						<div class="header__auth" style="margin: auto; margin-top: 20px;position: relative;" >
                         <form action="{{URL::to('/seach')}}" class="header_search" method="POST" >
                                
                                {{ csrf_field()}}
                                <input class="form-control" type="text" placeholder="Search..." name="keywords_submit" id="keywords" style="width: 400px;" >
                               
                                <button type="submit" class="header_search-button" style="font-size: 15px;color: white">Tìm Kiếm</button>
...
<center><div style="margin-top: 100px" class="uniad-ad-wraper uniad-flash-wraper uniad-zonetype-basic" style="width:100%;">
	<a href="{{$pro->quangcao_link}}" target="_blank"><img
 src="{{URL::to('public/uploads/product/'.$pro->product_image)}}" alt="Tạo cửa
 sổ Popup đơn giản dạng Modal" width="100%" height="150"></a>
</div></center>
...
<div id="modalimg" class="modalwindow"> 
 ...
 </h3> <a href="{{$pro->quangcao_link}}" target="_blank"><img
 src="{{URL::to('public/uploads/product/'.$pro->product_image)}}" alt="Tạo cửa
 sổ Popup đơn giản dạng Modal" width="100%" height="250"></a>
</div>
@endforeach	
