    ...
    public function AuthLogin(){
      ...
      $user = useradmin::where('admin_id')->get();
       $url_canonical = $request->url();
        ...
        return view('trangchu.chitietphim.watch')->with('theloai',$theloai)->with('year',$year)->with('quocgia',$quocgia)->with('watch',$watch)->with('url_canonical',$url_canonical)->with('quangcao',$quangcao)->with('quangcao',$quangcao)->with('filmlienquan1',$filmlienquan1)->with('comment',$comment)->with('film',$film);;
        }
